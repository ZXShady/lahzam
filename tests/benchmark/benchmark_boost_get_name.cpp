...
struct Members {
#if COUNT == 128
  T _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22, _23, _24,
...
{
  int c[] = {(boost::pfr::get_name<Is, T>(), 0)...};
  (void)c;
  return 0;
}
...
int main()
{
  []<std::size_t... Is>(std::index_sequence<Is...>) {
    int c[]{test<Members<Is>>(std::make_index_sequence<COUNT>{})...};
    (void)c;
  }(std::make_index_sequence<TEMPLATES>{});
}